...
var exampleRequiredUser = map[string]permIDs{
	...
	"agenda/list-of-speakers:10": {
		"agenda.can_see_list_of_speakers",
		[]int{},
	},
	"agenda/list-of-speakers:11": {
		"agenda.can_see_list_of_speakers",
		[]int{},
	},
	"agenda/list-of-speakers:12": {
		"agenda.can_see_list_of_speakers",
		[]int{},
	},
	"agenda/list-of-speakers:13": {
		"agenda.can_see_list_of_speakers",
		[]int{},
	},
	"agenda/list-of-speakers:14": {
		"agenda.can_see_list_of_speakers",
		[]int{},
	},
	"agenda/list-of-speakers:2": {
		"agenda.can_see_list_of_speakers",
		[]int{},
	},
	"agenda/list-of-speakers:3": {
		"agenda.can_see_list_of_speakers",
		[]int{},
	},
	"agenda/list-of-speakers:4": {
		"agenda.can_see_list_of_speakers",
		[]int{},
	},
	"agenda/list-of-speakers:5": {
		"agenda.can_see_list_of_speakers",
		[]int{},
	},
	"agenda/list-of-speakers:6": {
		"agenda.can_see_list_of_speakers",
		[]int{},
	},
	"agenda/list-of-speakers:7": {
		"agenda.can_see_list_of_speakers",
		[]int{6, 7},
	},
	"agenda/list-of-speakers:8": {
		"agenda.can_see_list_of_speakers",
		[]int{},
	},
	"agenda/list-of-speakers:9": {
		"agenda.can_see_list_of_speakers",
		[]int{},
	},
	...
	"assignments/assignment-option:2": {
		"assignments.can_see",
		[]int{3},
	},
